...
keywords: Azure, java, SDK, API, azure-resourcemanager-datamigration, databasemigrationservice
author: maggiepint
ms.author: magpint
ms.date: 11/16/2021
ms.topic: reference
...
# Azure Resource Manager DataMigration client library for Java - Version 1.0.0-alpha.20211115.1 
