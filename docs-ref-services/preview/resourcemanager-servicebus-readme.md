...
keywords: Azure, java, SDK, API, azure-resourcemanager-servicebus, servicebus
author: maggiepint
ms.author: magpint
ms.date: 11/23/2021
ms.topic: reference
...
# Azure Resource Manager ServiceBus client library for Java - Version 2.11.0-alpha.20211122.5 
...
<!-- embedme ./src/samples/java/com/azure/resourcemanager/servicebus/ReadmeSamples.java#L21-L26 -->
```java
