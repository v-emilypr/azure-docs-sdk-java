...
keywords: Azure, java, SDK, API, azure-resourcemanager-storageimportexport, storageimport/export
author: maggiepint
ms.author: magpint
ms.date: 11/09/2021
ms.topic: reference
...
# Azure Resource Manager StorageImportExport client library for Java - Version 1.0.0-alpha.20211109.1 
