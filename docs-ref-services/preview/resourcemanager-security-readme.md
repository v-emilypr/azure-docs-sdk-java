...
keywords: Azure, java, SDK, API, azure-resourcemanager-security, securitycenter
author: maggiepint
ms.author: magpint
ms.date: 11/11/2021
ms.topic: reference
...
# Azure Resource Manager Security client library for Java - Version 1.0.0-alpha.20211111.1 
