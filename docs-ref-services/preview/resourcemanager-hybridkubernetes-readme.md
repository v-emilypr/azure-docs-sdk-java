...
keywords: Azure, java, SDK, API, azure-resourcemanager-hybridkubernetes, connectedcluster
author: maggiepint
ms.author: magpint
ms.date: 11/12/2021
ms.topic: reference
...
# Azure Resource Manager HybridKubernetes client library for Java - Version 1.0.0-alpha.20211111.1 
