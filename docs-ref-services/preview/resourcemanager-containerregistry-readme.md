...
# Azure Resource Manager Containerregistry client library for Java - Version 2.10.0-alpha.20211103.2 
...
<!-- embedme ./src/samples/java/com/azure/resourcemanager/containerregistry/ReadmeSamples.java#L21-L26 -->
```java
