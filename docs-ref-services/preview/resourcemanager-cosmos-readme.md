...
# Azure Resource Manager Cosmos client library for Java - Version 2.10.0-alpha.20211112.1 
...
<!-- embedme ./src/samples/java/com/azure/resourcemanager/cosmos/ReadmeSamples.java#L21-L26 -->
```java
