...
keywords: Azure, java, SDK, API, azure-resourcemanager-cdn, contentdeliverynetwork
author: maggiepint
ms.author: magpint
ms.date: 11/20/2021
ms.topic: reference
...
# Azure Resource Manager CDN client library for Java - Version 2.10.0-alpha.20211119.1 
...
<!-- embedme ./src/samples/java/com/azure/resourcemanager/cdn/ReadmeSamples.java#L21-L26 -->
```java
