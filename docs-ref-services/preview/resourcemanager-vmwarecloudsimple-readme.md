...
keywords: Azure, java, SDK, API, azure-resourcemanager-vmwarecloudsimple, vmwaresolutionbycloudsimple
author: maggiepint
ms.author: magpint
ms.date: 11/22/2021
ms.topic: reference
...
# Azure Resource Manager VMwareCloudSimple client library for Java - Version 1.0.0-alpha.20211122.1 
