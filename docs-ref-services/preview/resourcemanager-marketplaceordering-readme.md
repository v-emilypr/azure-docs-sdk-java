...
keywords: Azure, java, SDK, API, azure-resourcemanager-marketplaceordering, marketplaceagreements
author: maggiepint
ms.author: magpint
ms.date: 11/18/2021
ms.topic: reference
...
# Azure Resource Manager MarketplaceOrdering client library for Java - Version 1.0.0-alpha.20211118.1 
