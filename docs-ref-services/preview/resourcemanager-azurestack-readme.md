...
keywords: Azure, java, SDK, API, azure-resourcemanager-azurestack, azurestack
author: maggiepint
ms.author: magpint
ms.date: 11/01/2021
ms.topic: reference
...
# Azure Resource Manager AzureStack client library for Java - Version 1.0.0-alpha.20211101.1 
